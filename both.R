...
df<- ovun.sample(polarity_level ~ ., data = x, method = "both", p=0.5)$data
...
dtm.train <- dtm[1:658,]
dtm.test <- dtm[659:878,]

corpus.clean.train <- corpus.clean[1:658]
corpus.clean.test <- corpus.clean[659:878]
